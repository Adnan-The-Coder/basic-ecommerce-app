...
function Topbar() {
  ...
  return (
    <div className="sticky top-0 z-50 p-2  bg-gradient-to-r from-yellow-300 to-orange-400 text-gray-100">
      <div className="mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-2 md:space-x-4 text-2xl md:text-3xl text-gray-900 mb-2 md:mb-0">
          ...
          <a href="#!" className="text-xl md:text-2xl hover:text-blue-900" onClick={handleYoutubeClick}>
           <IoLogoYoutube />
          </a>
